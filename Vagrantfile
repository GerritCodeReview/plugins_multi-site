...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", 
    inline: "cd /vagrant/ && set -x; setup_local_env/setup.sh --release-war-file /home/vagrant/gerrit/release.war --multisite-lib-file /home/vagrant/gerrit/multi-site.jar"
end
