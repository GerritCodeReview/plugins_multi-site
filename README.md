...
the git-upload-packs. They read-only masters are kept updated to be always ready
...
The multi-site plugin is build as any other Gerrit plugin in tree mode, by cloning
...
```
[kafka]
  bootstrapServers = kafka.mycompany.com:9092
