...
echo "Downloading zookeeper plugin stable 3.1"
	wget https://gerrit-ci.gerritforge.com/view/Plugins-stable-3.1/job/plugin-zookeeper-gh-bazel-stable-3.1/lastSuccessfulBuild/artifact/bazel-bin/plugins/zookeeper/zookeeper.jar \
