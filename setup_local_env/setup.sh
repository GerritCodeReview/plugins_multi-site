...
function cleanup_plugins {
  ...
  rm -f $DEPLOYMENT_LOCATION/multi-site.jar
  rm -f $DEPLOYMENT_LOCATION/events-broker.jar
  rm -f $DEPLOYMENT_LOCATION/global-refdb.jar
  rm -f $DEPLOYMENT_LOCATION/websession-broker.jar
  rm -f $DEPLOYMENT_LOCATION/healthcheck.jar
  rm -f $DEPLOYMENT_LOCATION/zookeeper-refdb.jar
  rm -f $DEPLOYMENT_LOCATION/events-kafka.jar
  rm -f $DEPLOYMENT_LOCATION/events-aws-kinesis.jar
  rm -f $DEPLOYMENT_LOCATION/events-gcloud-pubsub.jar
  rm -f $DEPLOYMENT_LOCATION/metrics-reporter-prometheus.jar
  rm -f $DEPLOYMENT_LOCATION/pull-replication.jar
}
