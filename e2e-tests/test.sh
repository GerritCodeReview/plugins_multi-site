...
docker-compose -f ${DEPLOYMENT_LOCATION}/docker-compose-setup.yaml --verbose up -d zookeeper kafka
docker-compose -f ${DEPLOYMENT_LOCATION}/docker-compose-setup.yaml logs -f --no-color -t > ${DEPLOYMENT_LOCATION}/site.log &

docker-compose -f ${DEPLOYMENT_LOCATION}/docker-compose-setup.yaml --verbose up --no-start gerrit1 gerrit2
...
docker-compose -f ${DEPLOYMENT_LOCATION}/docker-compose-setup.yaml --verbose up --no-start tester
