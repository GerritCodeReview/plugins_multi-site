...
docker-compose -f ${DEPLOYMENT_LOCATION}/docker-compose-setup.yaml up -d zookeeper kafka gerrit1 gerrit2
...
# capture container's id so that it could be used for checking its result status
