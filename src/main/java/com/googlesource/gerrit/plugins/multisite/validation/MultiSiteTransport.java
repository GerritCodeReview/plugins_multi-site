...
public class MultiSiteTransport extends Transport {
  ...
  public interface Factory {
    MultiSiteTransport create(Repository repo, URIish uri, Transport transport);
  }
  ...
  public PushResult push(
      ...
      throws NotSupportedException, TransportException {
    return baseTransport.push(monitor, toPush, out);
  }

  @Override
  public PushResult push(ProgressMonitor monitor, Collection<RemoteRefUpdate> toPush)
      throws NotSupportedException, TransportException {
    return baseTransport.push(monitor, toPush);
  }
