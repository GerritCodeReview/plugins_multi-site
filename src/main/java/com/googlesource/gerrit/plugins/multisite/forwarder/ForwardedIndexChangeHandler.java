...
public class ForwardedIndexChangeHandler
  ...
  @Override
  public void attemptToIndex(String id, Optional<ChangeIndexEvent> indexEvent, int retryCount) {
    ChangeChecker checker = changeCheckerFactory.create(id);
    if (checker.getChangeNotes().isPresent()) {
      checkOrReschedule(id, indexEvent, checker, retryCount);
    } else {
      log.warn(
