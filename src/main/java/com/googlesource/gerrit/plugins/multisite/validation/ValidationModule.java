...
public class ValidationModule extends FactoryModule {
  ...
  protected void configure() {
    ...
    DynamicSet.bind(binder(), GitRepositoryManager.class).to(MultiSiteGitRepositoryManager.class);
    DynamicSet.bind(binder(), SharedRefDatabase.class).to(ZkSharedRefDatabase.class);
