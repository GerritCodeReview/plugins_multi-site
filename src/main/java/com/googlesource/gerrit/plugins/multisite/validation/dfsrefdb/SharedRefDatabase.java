...
public interface SharedRefDatabase {
  ...
  /**
   * Verify if the DB contains a tombstone value for the specific project and ref name
   *
   * @param project
   * @param refName
   * @return true if the ref exists on the project and it is set to tombstone
   */
