...
public class IndexEventRouter implements ForwardedEventRouter<IndexEvent> {
  ...
  public void onRefReplicated(RefReplicatedEvent replicationEvent)
      throws IOException, OrmException {
    if (replicationEvent.project.equals(allUsersName.get())) {
      Account.Id accountId = Account.Id.fromRef(replicationEvent.ref);
      if (accountId != null) {
