...
class IndexEventHandler
  ...
  class IndexChangeTask extends IndexTask {
    ...
    public String toString() {
      return String.format(
          "[%s] Index change %s in target instance", Configuration.PLUGIN_NAME, changeIndexEvent.changeId);
    }
  }
  ...
  class IndexAccountTask extends IndexTask {
    ...
    public String toString() {
      return String.format(
          "[%s] Index account %s in target instance", Configuration.PLUGIN_NAME, accountIndexEvent.accountId);
    }
  }
  ...
  class IndexGroupTask extends IndexTask {
    ...
    public String toString() {
      return String.format(
          "[%s] Index group %s in target instance", Configuration.PLUGIN_NAME, groupIndexEvent.groupUUID);
    }
  }
  ...
  class IndexProjectTask extends IndexTask {
    ...
    public String toString() {
      return String.format(
          "[%s] Index project %s in target instance", Configuration.PLUGIN_NAME, projectIndexEvent.projectName);
    }
  }
}
