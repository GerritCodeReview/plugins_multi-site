...
public class Configuration {
  ...
  public static class ReplicationFilter {
    ...
    static final String REPLICATION_FETCH_FILTER_SUBSECTION = "push-filter";

    private static final String MIN_WAIT_BEFORE_RELOAD_LOCAL_VERSION_MS =
        "minWaitBeforeReloadLocalVersionMs";
    private static final String RANDOM_WAIT_BEFORE_RELOAD_LOCAL_VERSION_MS =
        "randomWaitBeforeReloadLocalVersionMs";

    private static final int MIN_WAIT_BEFORE_RELOAD_LOCAL_VERSION_MS_DEFAULT = 1000;
    private static final int RANDOM_WAIT_BEFORE_RELOAD_LOCAL_VERSION_MS_DEFAULT = 1000;
              ...
              () ->
                  cfg.get()
                      .getInt(
                          REPLICATION_FILTER_SECTION,
                          REPLICATION_FETCH_FILTER_SUBSECTION,
                          RANDOM_WAIT_BEFORE_RELOAD_LOCAL_VERSION_MS,
                          RANDOM_WAIT_BEFORE_RELOAD_LOCAL_VERSION_MS_DEFAULT));
    ...
    public Integer fetchFilterRandomSleepTimeMsec() {
    ...
    public Integer pushFilterRandomSleepTimeMsec() {
