...
public class Configuration {
  ...
  public static class Index {
    ...
    public boolean isAllIndexesEnabled() {
      return synchronize().contains(IndexType.TRUE);
    }

    public boolean isAllIndexesDisabled() {
      return synchronize().contains(IndexType.FALSE);
    }

    public boolean shouldIndex(String indexTypeString) {
      if (isAllIndexesEnabled()) {
        return true;
      }
      if (isAllIndexesDisabled()) {
        return false;
      }
