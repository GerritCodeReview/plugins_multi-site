...
public class Configuration {
  ...
  public Configuration(Config multiSiteConfig, Config replicationConfig) {
    ...
    replicationLagRefreshInterval = memoize(() -> 
    		Duration.ofMillis(
    		ConfigUtil.getTimeUnit(lazyMultiSiteCfg.get(), REF_DATABASE, null, REPLICATION_LAG_REFRESH_INTERVAL, REPLICATION_LAG_REFRESH_INTERVAL_DEFAULT.toMillis(), TimeUnit.MILLISECONDS)));
  }
