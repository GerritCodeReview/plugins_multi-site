...
public class Configuration {
  ...
  private static final String REF_LOCK_TIMEOUT = "refLockTimeout";
  private static final Duration REF_LOCK_TIMEOUT_DEFAULT = Duration.ofSeconds(30);
        ...
        memoize(
            () ->
                ConfigUtil.getTimeUnit(
                    ...
                    null,
                    REF_LOCK_TIMEOUT,
                    REF_LOCK_TIMEOUT_DEFAULT.toMillis(),
                    TimeUnit.MILLISECONDS));
  }
