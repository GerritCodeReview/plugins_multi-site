...
public class ForwardedCacheEvictionHandlerIT extends LightweightPluginDaemonTest {
  ...
  private static final Duration CACHE_EVICTION_TIMEOUT = Duration.ofSeconds(1);
  ...
  public void shouldEvictProjectCache() throws Exception {
    ...
    waitUntil(
        () -> CacheEvictionTest.numCacheEvictions(ProjectCacheImpl.CACHE_NAME) > 0, CACHE_EVICTION_TIMEOUT);
  }
}
