...
import com.googlesource.gerrit.plugins.multisite.validation.RefValidator;
import com.googlesource.gerrit.plugins.multisite.validation.RefValidator.Factory;
...
public class ZkSharedRefDatabaseIT extends AbstractDaemonTest implements RefFixture {
  ...
  private MultiSiteBatchRefUpdate newBatchRefUpdate(
    ...
    Factory batchRefValidatorFactory =
        new Factory() {
          @Override
          public RefValidator create(
              String projectName, RefDatabase refDb, BatchRefUpdate batchRefUpdate) {
