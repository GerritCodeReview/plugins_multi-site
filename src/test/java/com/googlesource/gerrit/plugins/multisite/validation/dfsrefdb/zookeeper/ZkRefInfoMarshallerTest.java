...
import com.googlesource.gerrit.plugins.multisite.validation.dfsrefdb.zookeeper.ZkRefInfoMarshaller.CorruptedZkStorageException;
...
public class ZkRefInfoMarshallerTest extends ZookeeperTestContainerSupport {
  ...
  public void shouldCheckExistenceOfRef() throws Exception {
    assertThat(marshaller.exists(ZkRefInfoMarshaller.pathFor(aZkRefInfo()))).isFalse();
