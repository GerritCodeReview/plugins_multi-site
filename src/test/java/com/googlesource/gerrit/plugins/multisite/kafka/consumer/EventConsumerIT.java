...
public class EventConsumerIT extends LightweightPluginDaemonTest {
  ...
  static {
    System.setProperty("gerrit.notedb", "READ_WRITE");
  }
  ...
  public void createChangeShouldPropagateChangeIndexAndRefUpdateStreamEvent() throws Exception {
    ...
    List<Event> createdChangeEvents = receiveFromQueue(droppedEventsQueue, 4);
    ...
    assertThat(
            createdChangeEvents
                ...
                .collect(toSet()))
        .containsExactlyElementsIn(
            ImmutableList.of("refs/sequences/changes", change.currentPatchSet().getRefName()));
