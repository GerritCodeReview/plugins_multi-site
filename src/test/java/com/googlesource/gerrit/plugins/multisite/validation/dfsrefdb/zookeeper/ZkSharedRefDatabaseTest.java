  ...
  public void aBatchWithOneFailedCommandShouldFailAllOtherCommands() throws Exception {
    ...
    assertThat(
            zookeeperContainer
                ...
                .checkExists()
                .forPath(
                    zkSharedRefDatabase.pathFor(A_TEST_PROJECT_NAME, firstCommand.getRefName())))
        .isEqualTo(null);
    assertThat(
            zookeeperContainer
                .getCurator()
                .checkExists()
                .forPath(
                    zkSharedRefDatabase.pathFor(
                        A_TEST_PROJECT_NAME, aNonFastForwardUpdate.getRefName())))
        .isEqualTo(null);
    assertThat(
            zookeeperContainer
                .getCurator()
                .checkExists()
                .forPath(zkSharedRefDatabase.pathFor(A_TEST_PROJECT_NAME, aNewCreate.getRefName())))
        .isEqualTo(null);
  }
