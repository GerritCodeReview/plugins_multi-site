...
public class ZkSharedRefDatabaseTest implements RefFixture {
  ...
  public void anImmutableChangeShouldBeIgnored() {
    Ref immutableChangeRef = zkSharedRefDatabase.newRef("refs/changes/01/1/1", AN_OBJECT_ID_1);
  ...
  public void anImmutableChangeLargerNumbersShouldBeIgnored() {
    Ref immutableChangeRef = zkSharedRefDatabase.newRef("refs/changes/999/999/999", AN_OBJECT_ID_1);
    assertThat(zkSharedRefDatabase.ignoreRefInSharedDb(immutableChangeRef)).isTrue();
  }
