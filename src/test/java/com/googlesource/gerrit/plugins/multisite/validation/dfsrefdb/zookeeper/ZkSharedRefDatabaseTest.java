...
public class ZkSharedRefDatabaseTest extends AbstractDaemonTest implements RefFixture {
  ...
  public void aBatchWithOneFailedCommandShouldFailAllOtherCommands() throws Exception {
    ...
    assertThat(existsInZKForCommand(firstCommand)).isEqualTo(false);
    assertThat(existsInZKForCommand(aNonFastForwardUpdate)).isEqualTo(false);
    assertThat(existsInZKForCommand(aNewCreate)).isEqualTo(false);
  }

  private boolean existsInZKForCommand(ReceiveCommand firstCommand) throws Exception {
