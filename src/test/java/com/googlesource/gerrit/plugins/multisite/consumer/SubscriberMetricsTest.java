...
public class SubscriberMetricsTest {
  ...
  public void setup() throws Exception {
    ...
    Provider<ImmutableList<ProjectData>> projectData =  () -> {
      return ImmutableList.<ProjectData>builder().add(new ProjectData(Project.builder(A_TEST_PROJECT_NAME_KEY).build(), Optional.empty())).build();
    };

    metrics = new SubscriberMetrics(metricMaker, replicationStatus, projectData);
