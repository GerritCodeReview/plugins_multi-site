...
public class SubscriberMetricsTest {
  ...
  public void shouldLogProjectDeletionWhenReceivingProjectListUpdateWithRemoveFlag() {
    EventMessage eventMessage = new EventMessage(msgHeader, projectListUpdateRemovalEvent());
  ...
  public void shouldNotLogProjectDeletionWhenReceivingProjectListUpdateWithoutRemoveFlag() {
    EventMessage eventMessage = new EventMessage(msgHeader, projectListUpdateEvent());
  ...
  public void shouldRemoveProjectMetricsWhenDeleted() {
    ...
    EventMessage projectDeleteEvent = new EventMessage(msgHeader, projectListUpdateRemovalEvent());
  ...
  private ProjectListUpdateEvent projectListUpdateRemovalEvent() {
    return new ProjectListUpdateEvent(A_TEST_PROJECT_NAME, true);
  }

  private ProjectListUpdateEvent projectListUpdateEvent() {
    return new ProjectListUpdateEvent(A_TEST_PROJECT_NAME, false);
  }
