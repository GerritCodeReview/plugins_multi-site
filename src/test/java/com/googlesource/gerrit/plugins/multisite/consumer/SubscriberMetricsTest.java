...
public class SubscriberMetricsTest {
  ...
  @Test
  public void
      shouldLogProjectDeletionWhenReceivingProjectDeletionSuccessAndLocalProjectDoesntExist()
          throws Exception {
  ...
  @Test
  public void shouldNotLogProjectDeletionWhenReceivingProjectDeletionSuccessButLocalProjectExists()
      throws Exception {
    EventMessage eventMessage = new EventMessage(msgHeader, projectDeletionSuccess());
  ...
  @Test
  public void shouldRemoveProjectMetricsWhenDeleted() throws Exception {
