...
public class InSyncChangeValidatorTest {
    ...
    public void shouldNotVerifyStatusOfImmutableRefs_ChangesRefs() throws ValidationException {
        final RefReceivedEvent refEvent = new RefReceivedEventBuilder().refName("refs/changes/97/187697/4").build();
    ...
    public void shouldFailRefUpdateIfRefIsNotInDfsRefDatabase() throws ValidationException {
        ...
        doThrow(notInDb).when(dfsRefDatabase)
                .updateRefId(refEvent.getRefName(), refEvent.command.getNewId(), refEvent.command.getOldId());
