...
public class Log4jSharedRefLoggerTest extends AbstractDaemonTest {
  ...
  public void shouldLogBlobRefs() throws Exception {
    ...
    SharedRefLogEntry.UpdateBlob gotLogEntry =
        gson.fromJson(logWriter.toString(), SharedRefLogEntry.UpdateBlob.class);

    assertThat(gotLogEntry.type).isEqualTo(SharedRefLogEntry.Type.UPDATE_BLOB);
