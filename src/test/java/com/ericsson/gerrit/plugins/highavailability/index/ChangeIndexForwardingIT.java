...
public class ChangeIndexForwardingIT extends LightweightPluginDaemonTest {
  ...
  public void testChangeIndexForwarding() throws Exception {
    Result result = createChange();
    final String expectedRequest =
        "/plugins/high-availability/index/change/" + result.getChange().getId().get();
    ...
    gApi.changes().id(result.getChange().getId().get()).abandon();
