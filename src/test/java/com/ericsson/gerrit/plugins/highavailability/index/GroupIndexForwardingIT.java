...
public class GroupIndexForwardingIT extends LightweightPluginDaemonTest {
  private static final int PORT = 18891;
  ...
  public void testGroupIndexForwarding() throws Exception {
    String someGroupId = gApi.groups().create("someGroup").get().id;
    String someOtherGroupId = gApi.groups().create("someOtherGroup").get().id;
    final String expectedRequest = "/plugins/high-availability/index/group/" + someGroupId;
